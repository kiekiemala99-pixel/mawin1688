...
function previewAuthSecret(): string {
  ...
  const file = "/workspace/data/auth-secret";
  if (existsSync(file)) {
  ...
  globalAuthRef.__grokAuthPreviewSecret__ = minted;
  return minted;
}
...
const baseURL = explicitBaseURL ?? {
  allowedHosts: [...previewAllowedHosts, "localhost", "127.0.0.1", "[::1]", "*.onrender.com"],
